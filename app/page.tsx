...
import { Truck, Users, BarChart3, Clock, ArrowRight, CheckCircle, Star, Globe } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              Streamline Your <span className="text-blue-600">Freight Operations</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Powerful dispatch management system that helps you manage loads, drivers, and customers with ease.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Streamline operations with automated load assignments and status updates.
                </CardDescription>
              </CardHeader>
            </Card>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Trusted by Freight Companies Worldwide</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <CardContent className="pt-6">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">Operations Manager, Swift Logistics</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600 mb-4">
                  "The real-time tracking and automated workflows have made our dispatch operations incredibly
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">CEO, TransGlobal Freight</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600 mb-4">
                  "Customer support is outstanding and the platform is intuitive. Our team was up and running in just a
                  few days."
                </p>
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-gray-300 rounded-full mr-3"></div>
                  <div>
                    ...
                    <div className="text-sm text-gray-500">Dispatcher, Rapid Transit Co.</div>
                  </div>
                </div>
              </CardContent>
            </Card>
