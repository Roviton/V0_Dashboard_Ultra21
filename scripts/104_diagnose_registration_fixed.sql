-- Check the registration for office@aden.md with proper column alignment
SELECT 
...
FROM companies 
WHERE email = 'office@aden.md' OR contact_email = 'office@aden.md'
...
WHERE c.email = 'office@aden.md' OR c.contact_email = 'office@aden.md' OR u.email = 'office@aden.md';
